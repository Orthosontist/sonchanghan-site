...
작성자 확인: 앞니 공간·정중선 증례의 치료 기간은 원문의 1년 3개월이 기준입니다.
사진 촬영 직후 치료가 시작되는 것이 아니므로 사진 날짜 차이로 치료 기간을 계산하지 않습니다.
치료 기간은 duration_months(총 개월 수)에 저장하고 목록과 상세 요약에 년·개월 형식으로 표시합니다.
목록과 요약에는 치료 기간만 표시하며 촬영일, 시작·종료 월, 보철 완료까지의 기간을 덧붙이지 않습니다.
PC 사진 크기는 큰 임상사진, 중간 크기, 작은 그림·중첩 중에서 선택합니다.
사진 묶음은 PC에서 좌우 또는 세 장 나란히 표시할 수 있으며 모바일에서는 위아래로 표시합니다.
